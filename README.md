...
## Final Conclusion
To improve the sales of this business retail, based on the metric market analysis showing a downward sales tren in the middle of the month an instability, therefore the marketing strategic plan will focuses on offering product discount through advertisements to customers in the middle of the month to stabilize market sales trends. Create bundling promotions for product categories that contriute significantly to store revenue such as electronis, home appliances, and clothing. to understand market in various region, create a filter ads to targeted ads for specific region with the products superior in various region.
